...
DO:
    ...
    IF yn = YES THEN
    DO:
        OUTPUT TO VALUE("E:\ICS_\bin\print\Collection_Report.txt"). 
        ...
        OUTPUT TO VALUE("E:\ICS_\bin\print\CollectionChart.txt").

        PUT UNFORMAT STRING(chartString).

        OUTPUT CLOSE.

        DOS SILENT START VALUE("E:\ICS_\bin\print\CollectionReport.bat").       
        DOS SILENT START excel VALUE("E:\ICS_\bin\print\CollectionReport.xlsx").
