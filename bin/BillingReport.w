...
DO:
    ...
    DO:
        ...
        OUTPUT TO VALUE("E:\ICS_\bin\print\Daily_Report.txt").
        ...
        DOS SILENT START VALUE("E:\ICS_\bin\print\BillingReport.bat").
        DOS SILENT START excel VALUE("E:\ICS_\bin\print\BillingReport.xlsx").
    END.
