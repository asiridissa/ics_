...
btnModBill btnDelBill brwBill btnSearch brw filSearch cmbSearchArea RECT-11 ~
RECT-12 RECT-13 RECT-15 RECT-14 
&Scoped-Define DISPLAYED-OBJECTS cmbArea cmbCus cmbVeh cmbEmp ~
filDiscountRate filPaid cmbName filPieses filGoodP filDamP filExpP ~
filDiscountRateItem filBill# cmbSearchCol cmbSearchTime filTotal ~
filDiscountedTotal filDiscountedAmount filAmount filSearch filRecipt# filKg ~
filUnitPrice filCasePrice cmbSearchArea filStockP filPerCase filBillNo 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS NO-TAB-STOP SIZE 97.72 BY 15.04
         FONT 10
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS NO-TAB-STOP SIZE 97.72 BY 11.12
         FONT 10
...
DEFINE FRAME DEFAULT-FRAME
     cmbArea AT ROW 9.15 COL 8.86 COLON-ALIGNED WIDGET-ID 80
     cmbCus AT ROW 10.15 COL 8.86 COLON-ALIGNED WIDGET-ID 92
     cmbVeh AT ROW 11.15 COL 8.86 COLON-ALIGNED WIDGET-ID 84
     cmbEmp AT ROW 12.15 COL 8.86 COLON-ALIGNED WIDGET-ID 82
     filDiscountRate AT ROW 13.77 COL 31.57 COLON-ALIGNED NO-LABEL WIDGET-ID 118
     filPaid AT ROW 14.88 COL 9 COLON-ALIGNED WIDGET-ID 142 NO-TAB-STOP 
     btnAdd AT ROW 16.27 COL 15 RIGHT-ALIGNED WIDGET-ID 42
     cmbName AT ROW 21.54 COL 9 COLON-ALIGNED WIDGET-ID 54
     filPieses AT ROW 22.54 COL 9 COLON-ALIGNED WIDGET-ID 32
     btnNewBill AT ROW 4.92 COL 2 WIDGET-ID 94 NO-TAB-STOP 
     filGoodP AT ROW 22.54 COL 34.86 COLON-ALIGNED WIDGET-ID 28
     filDamP AT ROW 23.54 COL 9 COLON-ALIGNED WIDGET-ID 38
     filExpP AT ROW 23.54 COL 34.86 COLON-ALIGNED WIDGET-ID 40
     filDiscountRateItem AT ROW 19.42 COL 31.57 COLON-ALIGNED NO-LABEL WIDGET-ID 122
     btnSave AT ROW 17.38 COL 9.14 WIDGET-ID 52
     filBill# AT ROW 7.31 COL 8.86 COLON-ALIGNED WIDGET-ID 2 NO-TAB-STOP 
     cmbSearchCol AT ROW 2.31 COL 6.72 COLON-ALIGNED WIDGET-ID 136 NO-TAB-STOP 
     cmbSearchTime AT ROW 3.35 COL 29.86 COLON-ALIGNED WIDGET-ID 130 NO-TAB-STOP 
     btnModBill AT ROW 4.96 COL 16.29 WIDGET-ID 96 NO-TAB-STOP 
     btnDelBill AT ROW 4.96 COL 30.57 WIDGET-ID 98 NO-TAB-STOP 
     brwBill AT ROW 1.12 COL 47.14 WIDGET-ID 300
     btnSearch AT ROW 2.23 COL 32 WIDGET-ID 134 NO-TAB-STOP 
     filTotal AT ROW 13.12 COL 8.86 COLON-ALIGNED WIDGET-ID 56 NO-TAB-STOP 
     filDiscountedTotal AT ROW 14 COL 8.86 COLON-ALIGNED WIDGET-ID 120 NO-TAB-STOP 
     btnCancel AT ROW 17.38 COL 23.43 WIDGET-ID 66 NO-TAB-STOP 
     btnDel AT ROW 16.27 COL 30.57 WIDGET-ID 48 NO-TAB-STOP 
     btnMod AT ROW 16.27 COL 16.29 WIDGET-ID 50 NO-TAB-STOP 
     filDiscountedAmount AT ROW 18.77 COL 9 COLON-ALIGNED WIDGET-ID 124 NO-TAB-STOP 
     brw AT ROW 12.35 COL 47.14 WIDGET-ID 200
     btnCancelBill AT ROW 6.04 COL 23.43 WIDGET-ID 154 NO-TAB-STOP 
     filAmount AT ROW 19.69 COL 9 COLON-ALIGNED WIDGET-ID 34 NO-TAB-STOP 
     filSearch AT ROW 1.31 COL 6.72 COLON-ALIGNED WIDGET-ID 126 NO-TAB-STOP 
     filRecipt# AT ROW 20.62 COL 9 COLON-ALIGNED WIDGET-ID 4 NO-TAB-STOP 
     filKg AT ROW 24.42 COL 9 COLON-ALIGNED WIDGET-ID 8 NO-TAB-STOP 
     filUnitPrice AT ROW 25.35 COL 9 COLON-ALIGNED WIDGET-ID 58 NO-TAB-STOP 
     filCasePrice AT ROW 26.27 COL 9 COLON-ALIGNED WIDGET-ID 64 NO-TAB-STOP 
     cmbSearchArea AT ROW 3.31 COL 6.72 COLON-ALIGNED WIDGET-ID 156 NO-TAB-STOP 
     filStockP AT ROW 25.35 COL 35 COLON-ALIGNED WIDGET-ID 158
     filPerCase AT ROW 24.42 COL 35 COLON-ALIGNED WIDGET-ID 162 NO-TAB-STOP 
     filBillNo AT ROW 7.35 COL 32 COLON-ALIGNED WIDGET-ID 168 NO-TAB-STOP 
     btnSaveBill AT ROW 6.04 COL 9.14 WIDGET-ID 170 NO-TAB-STOP 
     btnPayment AT ROW 14.73 COL 30.29 WIDGET-ID 172 NO-TAB-STOP 
     "Discount for Item" VIEW-AS TEXT
          SIZE 14 BY .58 AT ROW 18.77 COL 29.57 WIDGET-ID 152
     "Discount for Total" VIEW-AS TEXT
          SIZE 15 BY .58 AT ROW 13.19 COL 30.72 WIDGET-ID 148
     "Date:" VIEW-AS TEXT
          SIZE 5 BY .62 AT ROW 8.31 COL 6 WIDGET-ID 90
     RECT-11 AT ROW 4.81 COL 1.43 WIDGET-ID 138
     RECT-12 AT ROW 7.15 COL 1.43 WIDGET-ID 140
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 144.14 BY 26.54
         FONT 10 WIDGET-ID 100.

/* DEFINE FRAME statement is approaching 4K Bytes.  Breaking it up   */
DEFINE FRAME DEFAULT-FRAME
     RECT-13 AT ROW 16.12 COL 1.43 WIDGET-ID 146
     RECT-15 AT ROW 1.12 COL 1.43 WIDGET-ID 164
     RECT-14 AT ROW 16.12 COL 1.43 WIDGET-ID 166
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 144.14 BY 26.54
...
/* SETTINGS FOR BUTTON btnMod IN FRAME DEFAULT-FRAME
   NO-ENABLE                                                            */
/* SETTINGS FOR BUTTON btnPayment IN FRAME DEFAULT-FRAME
   NO-ENABLE                                                            */
...
"bills.BillNo" "Bill No" ? "int64" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
    ...
    DO:
        ...
        DISPLAY filBillNo filPaid brw filTotal cmbArea cmbCus cmbEmp cmbVeh filDiscountedTotal filDiscountRate filBill#
...
DO:
    ...
    DO:
        ...
        DISPLAY btnCancel btnSave filCasePrice cmbName filAmount filBill# filDamP filExpP filGoodP filKg filPieses filRecipt# filTotal filUnitPrice WITH FRAME DEFAULT-FRAME.
    END.
END.
...
/*             brw */
        ...
        DISPLAY filPaid filTotal btnCancel btnSave filCasePrice cmbName filAmount filBill# filDamP filExpP  filGoodP filKg filPieses filRecipt# filTotal filUnitPrice WITH FRAME DEFAULT-FRAME.
...
DO:
    ...
    ENABLE filBillNo filPaid filDiscountRate btnAdd btnMod btnDel btnSaveBill btnCancelBill cmbArea cmbCus cmbEmp cmbVeh WITH FRAME {&FRAME-NAME}.
    calendr:ENABLED = TRUE.
...
DO:
  ...
  END.
  RELEASE itms.
  DISPLAY filPerCase filStockP filKg filUnitPrice filCasePrice WITH FRAME {&FRAME-NAME}. 
  RUN calAmount.
END.
...
ON LEAVE OF filGoodP IN FRAME DEFAULT-FRAME /* Good Rtrn P */
DO:
    ASSIGN {&SELF-NAME}.
    RUN calAmount.
END.
...
PROCEDURE calAmount :
filAmount = ( filUnitPrice * filPieses ).
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY cmbArea cmbCus cmbVeh cmbEmp filDiscountRate filPaid cmbName filPieses 
          filGoodP filDamP filExpP filDiscountRateItem filBill# cmbSearchCol 
          ...
          cmbSearchArea filStockP filPerCase filBillNo 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE btnNewBill cmbSearchCol cmbSearchTime btnModBill btnDelBill brwBill 
         btnSearch brw filSearch cmbSearchArea RECT-11 RECT-12 RECT-13 RECT-15 
         RECT-14 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
