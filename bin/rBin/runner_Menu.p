...
DEFINE NEW GLOBAL SHARED VARIABLE session_User AS CHARACTER INIT "asiri".
DEFINE NEW GLOBAL SHARED VARIABLE session_UserType AS CHARACTER INIT "Super Admin".
